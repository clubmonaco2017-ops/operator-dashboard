-- Migration 101: include teams.lead_user_id in non-admin team_activity scoping.
-- teamlead/moderator are referenced via teams.lead_user_id but NOT in team_members
-- (team_members.operator_id is for operators only). Without this, leads/mods miss
-- events on teams they LEAD.
